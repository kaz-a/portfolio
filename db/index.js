...
const speeekDesc = 'Speeek is an app that listens to your speech, transcribes, and let you know when you are saying positive or negative words. It also gives you an analysis of your speech pattern in a nice d3 graph! This was a sole hackathon project that received the first prize! Implemented with Express.js, Sequelize.js, Postgresql, React/Redux, d3.js',
  ...
  nyccasDesc = 'Air Quality Monitoring app to visualize real-time pm2.5 readings in NYC. An ongoing project at NYC Department of Health. I have been the sole developer for this project. Currently in the process of redesigning the user experience, as well as re-evaluating the technologies used (see the GITHUB LINK for details of the current app status)',  
...
const nyccasCaptions = ['One page app showing date, Air Quality Index and Weather information on top. The background color changes based on the time of the day!', 'Click on a data point to show the 1 week trend of pm2.5 values at that location. Legend on top highlights and let you know where that value falls in the regulations!', 'Turn on the "Annual Average" checkbox to overlay the raster (satellite) data of annual average pm2.5', 'Click on the "current" tab to show the current pm2.5 data instead of rolling 24-hour data', 'It is fully responsive!']
...
.then(() => {
  return Promise.all([
    ...
    Detail.create({ desc: nyccasDesc, images: ['/images/nyccas1.png', '/images/nyccas2.png', '/images/nyccas3.png', '/images/nyccas4.png', '/images/nyccas5.png'], captions: nyccasCaptions, githubUrl: 'https://github.com/kaz-a/nyccas-react', publicUrl: 'http://nyccas.herokuapp.com/internal' }),
