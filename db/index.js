...
.then(() => {
  return Promise.all([
    ...
    Detail.create({ desc: nyccasDesc, images: ['/images/nyccasday.png', '/images/nyccasnight.png', '/images/nyccasweather.png', '/images/nyccasaqi.png', '/images/nyccasabout.png', '/images/nyccas1.png', '/images/nyccas2.png', ], captions: nyccasCaptions, githubUrl: 'https://github.com/kaz-a/nyccas-react', publicUrl: 'http://nyccas-react.herokuapp.com/' }),
