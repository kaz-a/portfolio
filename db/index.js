...
const speeekDesc = 'Speeek is an app that listens to your speech, transcribes, and let you know when you are saying positive or negative words. It also gives you an analysis of your speech pattern in a nice d3 graph! This was a sole hackathon project that received the first prize! Implemented with Express.js, Sequelize.js, Postgresql, React/Redux, d3.js',
  ...
  nyccasDesc = 'Air Quality Monitoring app to visualize real-time pm2.5 readings in NYC. An ongoing project at NYC Department of Health. I have been the sole developer for this project. Currently in the process of redesigning the user experience, as well as re-evaluating the technologies used (currently HTML, CSS, Javascript (d3.js and leaflet.js), python',  
...
.then(() => {
  return Promise.all([
    ...
    Detail.create({ desc: nyccasDesc, images: ['/images/nyccas1.png', '/images/nyccas2.png', '/images/nyccas3.png', '/images/nyccas4.png', '/images/nyccas5.png'], captions: nyccasCaptions, githubUrl: 'https://github.com/kaz-a/nyccas_node', publicUrl: 'http://nyccas.herokuapp.com/internal' }),
